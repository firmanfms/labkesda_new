        ...
        <form class="form-horizontal">
          <div class="box-body">
              ...
              <div class="col-sm-5">
                <select class="form-control select2" style="width: 100%;" id='id_lokasi'>
                  ...
                  foreach ($data_lokasi as $key => $value) {
                    if($value->id_lokasi==$detail->id_sub_lokasi){
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control" id="nama" placeholder="Sub Lokasi" value="<?= $detail->tempat ?>">
                <input type="hidden" class="form-control" id="id_sub_lokasi" placeholder="Sub Lokasi" value="<?= $detail->id_sub_lokasi ?>">
              </div>
            </div>
          </div>
...
$(document).ready(function(){
  ...
  function(e){
    ...
    $.ajax({
      url: baseUrl+'master/lokasi_sub/edit_act',
      type : "POST",  
      data: {
        nama          : $('#nama').val(),
      ...
      success : function(resp){
        if(resp.status == 'ERROR INSERT' || resp.status == false) {
          ...
          setTimeout(function () {
            window.location.href = baseUrl+'lokasi_sub/'; //will redirect to google.
          }, 2000);
        }
      }
    });
