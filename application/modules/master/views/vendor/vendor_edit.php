        ...
        <form class="form-horizontal">
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <input type="text" class="form-control" id="nama" placeholder="Nama Vendor" value="<?= $detail->nm_vendor; ?>">
                <input type="hidden" class="form-control" id="id_vendor" placeholder="Nama Vendor" value="<?= $detail->id_vendor; ?>">
              </div>
            </div>
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-2 control-label">Alamat</label>
              <div class="col-sm-9">
                <input type="text" class="form-control" id="alamat" placeholder="Alamat" value="<?= $detail->alamat; ?>">
              </div>
            </div>
          </div>
...
$(document).ready(function(){
  ...
  function(e){
    ...
    $.ajax({
      url: baseUrl+'master/vendor/edit_act',
      type : "POST",  
      data: {
        nama          : $('#nama').val(),
        alamat        : $('#alamat').val(),
