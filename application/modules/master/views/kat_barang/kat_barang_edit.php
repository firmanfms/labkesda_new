        ...
        <form class="form-horizontal">
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input id="kd_kat_barang" class="form-control" placeholder="Kode" value="<?php echo $detail->kd_kat_barang ?>"> <span style="color: red;font-size: 10px;">* Max & Min 3 Huruf</span>
              </div>
            </div>
            <div class="form-group">
