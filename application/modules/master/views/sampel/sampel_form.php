        ...
        <form class="form-horizontal">
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control" id="nama" placeholder="Nama Sampel">
              </div>
            </div>
            <div class="form-group">
...
$(document).ready(function(){
  ...
  function(e){
    ...
    $.ajax({
      url: baseUrl+'master/sampel/form_act',
      type : "POST",  
      data: {
        nama          : $('#nama').val(),
        kd_lab        : $('#kd_lab').val(),
      ...
      success : function(resp){
        if(resp.status == 'ERROR INSERT' || resp.status == false) {
          ...
          setTimeout(function () {
            window.location.href = baseUrl+'sampel/'; //will redirect to google.
          }, 2000);
        }
      }
    });
