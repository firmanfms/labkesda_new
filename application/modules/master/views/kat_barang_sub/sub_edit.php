<section class="content-header">
  <h1>
    Master
    <small>Input Sub Kategori Barang</small>
  </h1>
  <!-- <ol class="breadcrumb">
      ...
      <div class="box box-info">
        ...
        <form class="form-horizontal">
          <div class="box-body">
              ...
              <div class="col-sm-5">
                <select class="form-control select2" style="width: 100%;" id='id_kat_barang'>
                  ...
                  foreach ($data_kat as $key => $value) {
                    if($data_detail->id_kat_barang==$value->id_kat_barang){
            ...
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-2 control-label">Sub Kategori Barang</label>
              <div class="col-sm-5">
                <input type="text" class="form-control" id="nama" placeholder="Sub Lokasi" value="<?= $data_detail->kategori_sub; ?>">
                <input type="hidden" class="form-control" id="id_kat_barang_sub" placeholder="Sub Lokasi" value="<?= $data_detail->id_kat_barang_sub; ?>">
              </div>
            </div>
          </div>
...
$(document).ready(function(){
  ...
  function(e){
    ...
    $.ajax({
      url: baseUrl+'master/kat_barang_sub/edit_act',
      type : "POST",  
      data: {
        nama              : $('#nama').val(),
