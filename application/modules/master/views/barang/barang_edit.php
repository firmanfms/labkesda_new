        ...
        <form class="form-horizontal">
          <div class="box-body">
              ...
              <div class="col-sm-5">
                <select class="form-control select2" style="width: 100%;" id='id_vendor'>
                  ...
                  foreach ($data_vendor as $key => $value) {
                    if($value->id_vendor==$detail->id_vendor){
                      echo "<option value='".$value->id_vendor."' selected>".$value->nm_vendor."</option>";
                    }else{
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control" id="kemasan" placeholder="Kemasan Barang" value="<?= $detail->kemasan ?>">
              </div>
            </div>
            <div class="form-group">
                ...
                <select class="form-control select2" style="width: 100%;" id='id_kat_barang'>
                  ...
                  foreach ($data_katbarang as $key => $value) {
                    if($value->id_kat_barang==$detail->id_kat_barang){
                      echo "<option value='".$value->id_kat_barang."' selected data-kd_barang='".$value->kd_kat_barang."'>".$value->kategori."</option>";
                    }else{
              ...
              <div class="col-sm-5">
                <select class="form-control select2" style="width: 100%;" id='id_kat_barang_sub'>
                  ...
                  foreach ($data_sub as $key => $value) {
                    if($value->id_kat_barang_sub==$detail->id_kat_barang_sub){
                      echo "<option value='".$value->id_kat_barang_sub."' selected>".$value->kategori_sub."</option>";
                    }else{
                      echo "<option value='".$value->id_kat_barang_sub."' >".$value->kategori_sub."</option>";
                    }
                  }
                  ?>
                </select>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <div class="checkbox">
                  <label>
                    <input type="checkbox" id="lot_number" name="lot_number" value="Ya" <?= ($detail->is_lot=='Y')? 'checked' : ''; ?>> Ya
                  </label>
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control" id="kd_ekatalog" placeholder="Kode e-Katalog" value="<?= $detail->kd_ekatalog; ?>">
              </div>
            </div>
          </div>
