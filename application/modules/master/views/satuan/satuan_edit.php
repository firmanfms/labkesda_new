        ...
        <form class="form-horizontal">
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control" id="nama" placeholder="Satuan" value="<?= $detail->satuan ?>">
                <input type="hidden" class="form-control" id="id_satuan" placeholder="Satuan" value="<?= $detail->id_satuan ?>">
              </div>
            </div>
          </div>
...
$(document).ready(function(){
  ...
  function(e){
    ...
    $.ajax({
      url: baseUrl+'master/satuan/edit_act',
      type : "POST",  
      data: {
        nama          : $('#nama').val(),
