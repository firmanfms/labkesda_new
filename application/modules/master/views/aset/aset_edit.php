        ...
        <form class="form-horizontal">
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control" id="nama" placeholder="Nama Aset" value="<?= $data_aset->nama; ?>">
                <input type="hidden" class="form-control" id="id_assets" placeholder="Nama Aset" value="<?= $data_aset->id_assets; ?>">
              </div>
            </div>
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-2 control-label">Merk / Type </label>
              <div class="col-sm-2">
                <input type="text" class="form-control" id="merk" placeholder="Merk / Type" value="<?= $data_aset->merk; ?>">
              </div>
            </div>  
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-2 control-label">Serial Number </label>
              <div class="col-sm-3">
                <input type="text" class="form-control" id="serial_number" placeholder="Serial Number" value="<?= $data_aset->serial_number; ?>">
              </div>
            </div>
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-2 control-label">Tgl Perolehan </label>
              <div class="col-sm-2">
                <input type="date" class="form-control" id="tgl_perolehan" placeholder="Tanggal Perolehan" value="<?= $data_aset->tgl_perolehan; ?>">
              </div>
            </div>
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-2 control-label">Harga Perolehan </label>
              <div class="col-sm-3">
                <input type="number" class="form-control" id="harga_perolehan" placeholder="Harga Perolehan" value="<?= $data_aset->harga_perolehan; ?>">
              </div>
            </div>
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-2 control-label">Tipe Aset </label>
              <div class="col-sm-3">
                <select class="form-control select2" style="width: 100%;" id='tipe_aset'>
                  <option value="Aset Tetap" <?= ($data_aset->tipe_aset=='Aset Tetap')? 'selected' : ''; ?>>Aset Tetap</option>
                  <option value="Inventaris" <?= ($data_aset->tipe_aset=='Inventaris')? 'selected' : ''; ?>>Inventaris</option>
                </select>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <select class="form-control select2" style="width: 100%;" id='id_sumber'>
                  ...
                  foreach ($data_sumber as $key => $value) {
                    if($data_aset->id_sumber==$value->id_sumber){
              ...
              <div class="col-sm-2">
                <select class="form-control select2" style="width: 100%;" id='id_kondisi'>
                  ...
                  foreach ($data_kondisi as $key => $value) {
                    if($data_aset->id_kondisi==$value->id_kondisi){
                      echo "<option value='".$value->id_kondisi."' selected>".$value->kondisi."</option>";                    
                    }else{
            ...
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-2 control-label">Lokasi Penyimpanan Aset </label>
              <div class="col-sm-2">
                <select class="form-control select2" style="width: 100%;" id='id_lokasi'>
                  <option disabled="" selected="">- Pilih -</option>
                  <?php 
                  foreach ($data_assets as $key => $value) {
                    if($data_aset->id_lokasi==$value->id_lokasi){
              ...
              <div class="col-sm-2">
                <select class="form-control select2" style="width: 100%;" id='id_kat_barang'>
                  ...
                  foreach ($data_kategory as $key => $value) {
                    if($data_aset->id_kat_barang==$value->id_kat_barang){
            ...
            <div class="form-group">
              ...
              <div class="col-sm-1">
                <input type="number" class="form-control" id="jumlah" placeholder="Jumlah" value="<?= $data_aset->jumlah; ?>">
              </div>
            </div>
            <!-- <div class="form-group">
...
$(document).ready(function(){
  ...
  function(e){
    ...
    $.ajax({
      url: baseUrl+'master/aset/edit_act',
      type : "POST",  
      data: {
        id_assets       : $('#id_assets').val(),
        nama            : $('#nama').val(),
        merk            : $('#merk').val(),
