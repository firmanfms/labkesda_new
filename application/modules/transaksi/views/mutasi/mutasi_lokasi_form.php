<section class="content-header">
  <h1>
    Transaksi
    <small>Input Mutasi Gudang Keluar</small>
  </h1>
</section>
      ...
      <div class="box box-info">
        ...
        <form class="form-horizontal">
          ...
          <div class="box-footer">
            ...
            <a href="<?php echo base_url('transaksi/mutasi_lokasi/reset'); ?>" type="submit" class="btn btn-danger">Batal</a>
          </div>
        </form>
      </div>
    </div>
    ...
    let dialogshown = function(){
      ...
      metode.select_items_table = tbl.DataTable({
        ...
        ajax        : {
          ...
          url: baseUrl + 'transaksi/mutasi_lokasi/get_barang',
        ...
        columns     : [
          ...
          {"data"   : "nama"},
          {"data"   : "qty"},
          {"data"   : "lot_no", bVisible  : false},
          {"data"   : "tgl_kadaluwarsa", bVisible  : false}
        ],
...
$(document).ready(function(){
  ...
  metode = {
    ...
    _addtogrid: function(data){
      ...
      $.post({
        url: baseUrl+'transaksi/mutasi_lokasi/add_item',
        data: {
    ...
    _removefromgrid: function(el){
      ...
      $.get({
        url: baseUrl+'transaksi/mutasi_lokasi/remove_item',
        data: {
          index_id: id
        }
      });
    ...
    save: function(e){
      ...
      $.ajax({
        url: baseUrl+'transaksi/mutasi_lokasi/form_act',
        type : "POST",  
        data: {
          tanggal         : $('#tanggal').val(),
        ...
        success : function(resp){
          if(resp.status == 'ERROR INSERT' || resp.status == false) {
            ...
            setTimeout(function () {
              window.location.href = baseUrl+'transaksi/mutasi_lokasi/'; //will redirect to google.
            }, 2000);
          }
        }
      });
