<section class="content-header">
  <h1>
    Transaksi
    <small>Data Persediaan Masuk</small>
  </h1>
  <ol class="breadcrumb">
    <li><a style="color: white" type="submit" class="btn btn-block btn-primary" href="<?php echo base_url('transaksi/mutasi_masuk/form'); ?>">Input</a></li>
  </ol>
</section>
            ...
            <tr>
              ...
              <td align="center">
                ...
                if($value->approve_mutasi!=0){
                  ...
                  echo '<a type="submit" class="btn btn-xs btn-primary" href="'.base_url('transaksi/mutasi_masuk/batal/'.$value->id_mutasi).'">Batal</a>';
...
function show_detail(e){
  ...
  $.get({
    url: baseUrl + 'transaksi/mutasi_masuk/view_popup/'+noId,
        ...
        },
        {
          ...
          action: function(dia){
            ...
            $.ajax({
                ...
                type : "POST",
                url: baseUrl+'transaksi/mutasi_masuk/approve',
                success : function(resp){
