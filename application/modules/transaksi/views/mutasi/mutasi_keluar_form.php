<section class="content-header">
  <h1>
    Transaksi
    <small>Input Persediaan Keluar</small>
  </h1>
</section>
        ...
        <form class="form-horizontal">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type="text" class="form-control" id="no_referensi" placeholder="No. Referensi">
              </div>
            </div>
            <div class="form-group">
    ...
    let dialogshown = function(){
      ...
      metode.select_items_table = tbl.DataTable({
        ...
        columns     : [
          ...
          {"data"   : "nama"},
          {"data"   : "qty"},
          {"data"   : "lot_no","visible": false},
          {"data"   : "tgl_kadaluwarsa","visible": false}
        ],
    ...
    init: function(){
      this.grids = $('#detail').DataTable({
        ...
        columns: [
          ...
          { data: 'no_lot', bVisible  : false, className: "text-left"}, 
          { data: 'kadaluarsa', bVisible  : false, className: "text-left"}, 
