<section class="content-header">
  <h1>
    Transaksi
    <small>Input Adjustment Positif</small>
  </h1>
</section>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2">
                ...
                <input type="hidden" class="form-control" id="type_adjustment" placeholder="Harga Perolehan" value="Positif Adjustment">
              </div>
            </div>
            <div class="form-group">
    ...
    init: function(){
      this.grids = $('#detail').DataTable({
        ...
        columns: [
          ...
          { data: 'harga_perolehan', className: "text-right" }, 
