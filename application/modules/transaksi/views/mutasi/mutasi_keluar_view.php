<section class="content-header">
  <h1>
    Transaksi
    <small>Data Persediaan Keluar</small>
  </h1>
  <ol class="breadcrumb">
            ...
            <tr>
              ...
              <td align="center">
                ...
                if($value->approve_mutasi!=0){
                  ...
                  echo '<a type="submit" class="btn btn-xs btn-primary" href="'.base_url('transaksi/mutasi_keluar/batal/'.$value->id_mutasi).'">Batal</a> ';
                ...
                <button type="submit" class="btn btn-xs btn-info" id="delete" data-id_mutasi="<?php echo $value->id_mutasi; ?>" data-name="<?php echo $value->no_mutasi; ?>">Status</button>
                  <a href="<?php echo base_url('transaksi/mutasi_keluar/edit/'.$value->id_mutasi); ?>" type="submit" class="btn btn-xs btn-warning">Edit</a>
