      ...
      <div class="box">
        <div class="box-body">
          <table style="width:100%;font-family: initial;">
            ...
            <tr>
              <td colspan="4" align="center"><strong style="font-size: 22px;">Formulir Permintaan Pengujian Sampel Klinik</strong></td>
            </tr>
            <tr>
            ...
            <tr>
              <td colspan="4">
                <table style="width:100%;font-family: initial;border: 1px solid black;font-size: 14px;">
                  <tr>
                    <td width="15%">No. Lab</td>
                    <td width="30%">: <?php echo $header->no_pendaftaran; ?></td>
                    <td width="25%">Dokter </td>
                    <td width="30%">: <?php echo $header->dokter; ?></td>
                  </tr>
                  <tr>
                    <td>Nama </td>
                    <td>: <?php echo $header->nama; ?></td>
                    <td>Jenis Spesimen </td>
                    <td>: <?php echo $header->jenis_spesimen; ?>  </td>
                  </tr>
				  <tr>
                    <td>Alamat </td>
                  ...
                  <tr>
                    <td>Jenis Kelamin </td>
                    <td>: <?php echo ($header->jns_kelamin=='W')? 'Wanita' : 'Pria'; ?> </td>
                    <td>Lokasi Pengambilan Spesimen</td>
            ...
            <tr>
              <td colspan="4">
                <table style="width:100%;font-family: initial;border: 1px solid black;font-size: 16px;">
            ...
            <tr>
              <td colspan="4" align="left" style="font-size: 15px;"><br/>
          ...
          <table style="width:100%;font-family: initial;" class="break">
            <tr>
              <td colspan="4" style="font-size: 16px;">
                ...
                <table width="70%" style="font-size: 16px;">
                  <tr>
