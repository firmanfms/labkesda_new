      ...
      <div class="box">
        <div class="box-body">
          <table style="width:100%;font-family: initial;">
            ...
            <tr>
              <td colspan="4" align="center"><strong style="font-size: 22px;">Invoice Pengujian Sampel Makanan Dan Minuman</strong></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td width="15%">Keterangan Sampel</td>
              <td width="25%">: <?php echo $header->ket_sampel; ?></td>
            </tr>
            <tr>
              <td>Pemilik</td>
