      ...
      <div class="box box-info">
        ...
        <form class="form-horizontal">
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-3" style="top: 7px;">: 
                <input type="hidden" class="form-control pull-right" id="kd_lab" value="<?php echo $data_lab; ?>"> Lab Makanan dan Minuman
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                ...
                <input type="hidden" name="items" id="sup_items" value='<?php echo json_encode($new_maknum["items"]); ?>'/>
              </div>
            </div>
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-2 control-label">Nama Sampel</label>
              <div class="col-sm-5">
                <input type="text" class="form-control pull-right" id="uraian_sampel" value="<?php echo $header->uraian_sampel; ?>">
              </div>
            </div>

            <div class="form-group">
              <label for="inputEmail3" class="col-sm-2 control-label">Banyak Sampel</label>
              <div class="col-sm-5">
                <input type="text" class="form-control" id="banyak" placeholder="banyak" value="<?php echo $header->banyak; ?>">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <textarea class="form-control" name="Keterangan" id="keterangan"><?= $header->keterangan; ?></textarea>
              </div>
            </div>
            <!-- <div class="form-group">
          ...
          <div class="box-footer">
            ...
            <a href="<?php echo base_url('transaksi/pendaftaran_maknum/reset'); ?>" type="submit" class="btn btn-danger">Batal</a>
          </div>
        </form>
      </div>
    </div>
...
$(document).ready(function(){
  ...
  metode = {
    ...
    _addtogrid: function(data){
      ...
      $.post({
        url: baseUrl+'transaksi/pendaftaran_maknum/add_item',
        data: {
    ...
    _removefromgrid: function(el){
      ...
      $.get({
        url: baseUrl+'transaksi/pendaftaran_maknum/remove_item',
        data: {
          index_id: id
        }
      });
    ...
    save: function(e){
      ...
      $.ajax({
        url: baseUrl+'transaksi/pendaftaran_maknum/edit_act',
        type : "POST",  
        data: {
