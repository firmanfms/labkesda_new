      ...
      <div class="box">
        <div class="box-body">
          <table style="width:100%;font-family: initial;">
            ...
            <tr>
              <td colspan="4" align="center"><strong style="font-size: 22px;">Formulir Permintaan Pengujian Sampel Lingkungan</strong></td>
            </tr>
            <tr>
              ...
              <td colspan="4">
                <table style="width:100%;font-family: initial;border: 1px solid black;">
                  <tr>
                    ...
                    <td width="35%">: <?php echo $header->jns_analisa; ?></td>
                  </tr>
                   <tr>
                    <!-- <td>Alamat</td>
