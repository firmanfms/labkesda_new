        ...
        <form class="form-horizontal">
          <div class="box-body">
              ...
              <div class="col-sm-3">
                <select class="form-control select2" style="width: 100%;" id='kd_sampel'>
                  ...
                  foreach ($data_sampel as $key => $value) {
                    if($value->kd_sampel==$header->kd_sampel){
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <input type="datetime-local" class="tanggal form-control pull-right" id="tgl_diterima" value="<?php echo substr($header->tgl_diterima,0,10); ?>">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <input type="datetime-local" class="tanggal form-control pull-right" id="tgl_selesai" value="<?php echo substr($header->tgl_selesai,0,10); ?>">
              </div>
            </div>
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-2 control-label">Waktu Pengambilan Spesimen</label>
              <div class="col-sm-3">
                <input type="datetime-local" class="tanggal form-control pull-right" id="tgl_spesimen" value="<?php echo substr($header->tgl_spesimen,0,10); ?>">
              </div>
            </div>
            <div class="form-group">
                ...
                <dd>
                  ...
                  ?>                      
                      <div class="border-bottom">
                        ...
                        <div class="col-sm-1">
                        <input type="checkbox" id="kd_parameter" name="kd_parameter" onclick="return add_kode(this)"  data-kode="<?= $value2->kd_parameter; ?>" <?= ($value2->no_pendaftaran!='')? 'checked' : ''; ?> class='<?= $value1->kd_kategori_parameter; ?>'>
                        </div>
                      </div>
                  <?php 
                  }
          ...
          <div class="box-footer">
            ...
            <a href="<?php echo base_url('transaksi/pendaftaran_lingkungan/reset'); ?>" type="submit" class="btn btn-danger">Batal</a>
          </div>
        </form>
      </div>
    </div>
...
var kode_metode = <?= json_encode($metode); ?>.map(Number)
