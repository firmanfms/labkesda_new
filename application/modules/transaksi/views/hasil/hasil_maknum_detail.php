  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-info">
        ...
        <form class="form-horizontal" method="post" action="<?php echo base_url().'transaksi/hasil_maknum/insert_act'; ?>">
          <div class="box-body">
                ...
                <table id="detail2" class="table table-bordered table-striped">
                  <thead>
                    ...
                    <tr>
                      ...
                      <td>
                        <input disabled type="text" class="form-control pull-right" id="nama" name="hasil[<?php echo $no; ?>]" value="<?php echo $value2->nilai; ?>">
                        <input disabled type="hidden" class="form-control pull-right" id="nama" name="no_pendaftaran[<?php echo $no; ?>]" value="<?php echo $value2->no_pendaftaran; ?>">
                        <input disabled type="hidden" class="form-control pull-right" id="nama" name="kd_kategori_parameter[<?php echo $no; ?>]" value="<?php echo $value2->kd_kategori_parameter; ?>">
                      </td>
                      <td><input disabled type="text" class="form-control pull-right" id="nama" name="keterangan[<?php echo $no; ?>]" value="<?php echo $value2->ket; ?>"></td>
          ...
          <div class="box-footer">
            <a href="<?php echo base_url('transaksi/hasil_maknum/?tahun='.tengah($header->no_pendaftaran,3,4)); ?>" type="submit" class="btn btn-danger">Kembali</a>
          </div>
        </form>
      </div>
    </div>
