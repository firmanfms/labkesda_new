...
<style>
  ...
  @media print{
    ...
    @page {
      ...
      margin-right: 0.5cm;
      margin-left: 0.5cm;
      margin-top: 0.5cm; /* Adjust this if needed */
      margin-bottom: 0.5cm; /* Adjust this if needed */
      }
    }
  table{
  ...
  .header{
    padding: 0px 30px; 
    text-align: center;
    margin-top: -1cm; /* Negative margin to move the header up */
  }
  .header_alamat {
    border: 2px solid black;
    padding: 0px 30px; 
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="box">
        ...
        if($type_surat=="surat"){
        ?>
        <div class="box-body" style="page-break-before:always; page-break-after:always;">
          <table style="width:100%;font-family: 'Times New Roman', Times, serif;font-size: 13px" >
            ...
            <tr>
              <td colspan="4" style="text-align: justify" style="height:30">
        ...
        <div class="box-body" style="page-break-before:always; page-break-after:always;">
          <table style="width:100%;font-family: 'Times New Roman', Times, serif;font-size: 13px">
            ...
            <tr>
              <td colspan="4" align="center"><strong style="font-size: 16px;">Laporan Hasil Uji Lab Klinik</strong></td>
            </tr>
            <tr>
            ...
            <tr>
              <td>Alamat</td>
              <td>: <?php echo ucwords(strtolower($header->alamat)); ?></td>
              <!-- <td>Kondisi</td>
                ...
                <table style="width:100%;font-family: 'Times New Roman', Times, serif;border: 1px solid black;font-size: 13px" border='1'>
                  ...
                  <tr style="border: 1px solid black;background-color: #adadad;font-weight: 600">
                    ...
                    if($value->nilai_min!='0.00' AND $value->nilai_max!='0.00'){
                      if($value->nilai<$nilai_min OR $value->nilai>$nilai_max){
