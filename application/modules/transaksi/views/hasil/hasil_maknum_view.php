        ...
        <div class="box-body">
          <table id="itemsTable" class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td><?= $status; ?></td>
              <td align="center">
                <a href="<?php echo base_url('transaksi/hasil_maknum/detail/'.$value->nopendaftar.'/'.$value->max_urutan); ?>" type="submit" class="btn btn-xs btn-success">Detail</a>
                <?php 
                if($value->status_approve_query==3){
                ?>
                  <a href="<?php echo base_url('transaksi/hasil_maknum/insert/'.$value->nopendaftar.'/'.$value->max_urutan); ?>" type="submit" class="btn btn-xs btn-warning">Hasil</a>
                  <?php
                }else if($value->status_approve_query==1 OR $value->status_approve_query==4){
                ?>
                  <a href="<?php echo base_url('transaksi/hasil_maknum/update/'.$value->nopendaftar.'/'.$value->max_urutan); ?>" type="submit" class="btn btn-xs btn-warning">Hasil</a>
                <?php
                }
                ?>
                <?php
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Print Makanan & Minuman</h5>
      </div>
      <form action="<?= base_url("transaksi/hasil_maknum/print") ?>" method="post" target="_blank">
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <label class="radio-inline col-sm-2">
              <input type="radio" name="versi" id="versi" value="2"> Dua
            </label>
            <label class="radio-inline col-sm-2">
              <input type="radio" name="versi" id="versi" value="mikrobiologi"> Mikrobiologi
            </label>
          </div>
          <div class="row">
          ...
          <div class="row">
            ...
            <label class="radio-inline col-sm-3">
              <input type="radio" name="ttl" id="ttl" value="koor"> Koordinator Makmin
            </label>
          </div>
          <!-- <div class="row">
            <label class="col-sm-5 control-label">Kategori Parameter</label>
            <label class="radio-inline col-sm-3">
              <input type="radio" name="kat_parameter" id="kat_parameter" value="all" checked> ALL
            </label>
            <label class="radio-inline col-sm-3">
              <input type="radio" name="kat_parameter" id="kat_parameter" value="mikrobiologi"> Mikrobiologi
            </label>
          </div> -->
        </div>
...
<script type="text/javascript">
  ...
  var url = "<?php echo base_url('transaksi/hasil_maknum/'); ?>";
  url += "?tahun=" + tahun;
