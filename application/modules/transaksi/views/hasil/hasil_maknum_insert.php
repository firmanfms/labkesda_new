                  ...
                  <thead>
                    ...
                    <tr>
                      ...
                      <td><?php //echo $value2->kadar; ?>
                        <input type="text" class="form-control pull-right ckadar" data-parameter="<?= $value2->kd_parameter ?>"  id="kadar" name="kadar[<?php echo $no; ?>]" value="<?= ($value2->kadar!='')? $value2->kadar : $value2->m_kadar; ?>">
                      </td>
                      <td>
                        ...
                        <input type="hidden" class="form-control pull-right" id="nama" name="kd_kategori_parameter[<?php echo $no; ?>]" value="<?php echo $value2->kd_kategori_parameter; ?>">
