                ...
                <table id="detail2" class="table table-bordered table-striped">
                  <thead>
                    ...
                    foreach ($detail_kdpar as $key => $value) {
                      //test($value->kd_kategori_parameter,0);
                    ?>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <input type="hidden" class="form-control pull-right" id="nama" name="kd_parameter_old[<?php echo $no; ?>]" value="<?php echo $value2->kd_parameter; ?>">
