      ...
      <div class="box">
        ...
        <div class="box-body" style="page-break-before:always;">
          <table style="width:100%;font-family: initial;font-size: 13px">
            ...
            <tr>
              <td colspan="4" align="center"><strong style="font-size: 14px;">Laporan Hasil Uji Lab Lingkungan</strong></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td width="40%">: <?php echo $header->no_pendaftaran; ?></td>
              <td width="15%"></td>
              <td width="15%"></td>
            </tr>
            <tr>
                ...
                <table style="width:100%;font-family: initial;border: 1px solid black;font-size: 13px">
                  ...
                  <tr style="border: 1px solid black;background-color: #adadad;font-weight: 600">
                    ...
                    <tr style="border: 1px solid black">
                      ...
                      <td align="center"><?php echo $bold.' - '.$value->nilai_min.' - '.$value->nilai_max; ?></td>
