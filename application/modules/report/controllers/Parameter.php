...
class Parameter extends MY_Controller {
    ...
    function index(){  
        $this->session->set_userdata('ses_menu', array('active_menu' => 'Report', 'active_submenu' => 'report/parameter', 'active_submenu2' => ''));
        ...
        $this->template->load('body', 'report/parameter',$data);
    }
