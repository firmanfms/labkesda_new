...
<table class="table-no-border" style="margin: 20px;">
		...
		<td colspan="4" width="100%" valign="top">
			...
			<div class="row">
			    ...
			    <div class="col-md-3" style="margin-top: 20px;">
			    	<table class="table-with-border break" width="100%">
			    		<tr>
	...
	<tr>
		<td colspan="4" width="100%" valign="top">
			<div class="row ">
				<div class="col-md-12" style="margin-top: 20px;text-align-last: center;">
					<strong style="font-size:23px">JUMLAH KUNJUNGAN DAN PEMERIKSAAN LABORATORIUM MAKMIN<br/>
					UPT LABKESDA KOTA TANGERANG<br/>
					BULAN JULI 2023<br/></strong>
				</div>
			</div>
...
Highcharts.chart('container4', {
    ...
    series: [{
            name: 'Laboratorium',
            colorByPoint: false,
            data: <?php echo json_encode($makmin,1); ?>
    }]
});
