    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <form class="form-horizontal" action="<?= base_url('report/lab_lingkungan/print'); ?>" method='POST' target="_blank">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <button type="submit" class="btn btn-warning" id="add-items">Excell</button>
