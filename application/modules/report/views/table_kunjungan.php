<section class="content-header">
  <h1>
    Report
    <small>Tabel Kunjungan dan Pemeriksaan</small>
  </h1>
  <ol class="breadcrumb">
    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <form target="_blank" class="form-horizontal" action="<?= base_url('report/laboratorium/table_kunjungan_print'); ?>" method='POST'>
