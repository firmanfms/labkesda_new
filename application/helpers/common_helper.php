...
function routes(){
	include_once('routes_helper.php');
}

// function body(){
// 	include_once('body_helper.php');
// }
...
function tgl_print($timestamp = '', $date_format = ' j F Y ', $suffix = '') {
    if (trim ($timestamp) == '')
    {
            $timestamp = time ();
    }
...
function tgl_singkat_waktu($timestamp = '', $date_format = 'd/m/Y H:i:s', $suffix = 'WIB') {
    if (trim ($timestamp) == '')
    {
            $timestamp = time ();
    }
